200 !== $response.status && $done({}),
  (() => {
    ...
    function r() {
      let e = s.pop();
      return e
        ? ((e.offset = e.limit = 0), e)
        : { bytes: new Uint8Array(64), offset: 0, limit: 0 };
    }
    function o(e) {
      s.push(e);
    }
      ...
      let a =
        ...
        s = (function (a, s, u) {
          if (s.includes("/u")) {
            let i,
              l = t(n(u));
            return A(a, l.success), e(l, (i = r())), c(i);
          }
          {
            let s,
              b = (function (e) {
            ...
            return (
              A(a, b.ucsResponseV0.success.customization.success),
              (function (t, i) {
